...
#+author:Pinecone062
#+date:2019-11-20 00:25
#+macro:version 0.0.40
...
#+cindex:Void
#+cindex:Null
Every other type that exists in TypeScript falls into one of three
categories:
...
on the class itself rather than on the instances.  Static members are
accessible at any time by referencing the named type.  To declare a
static member, simply declare it with the ~static~ keyword.
