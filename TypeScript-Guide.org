...
#+name:greater.ts
#+header: :mkdirp yes
#+begin_src js :tangle examples/greeter.ts
...
#+name:greeter2.ts
#+begin_src js :tangle examples/greeter2.ts
...
#+begin_src js :tangle examples/greeter-wrong.ts
function greeter(person: string) {
    return "Hello, " + person;
}
